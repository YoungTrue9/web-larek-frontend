...
#### Web-larёk - 
удобный мини-интернет магазин в котором можно просмотреть каталог товаров. Можно совершать заказы и управлять своими покупками. Проект построен на базе передовых технологий. TypeScript, HTML,SCSS. Использоваться Webpack , чтобы обеспечить
